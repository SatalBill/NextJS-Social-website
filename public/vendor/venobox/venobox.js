        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    vbheader = '<div className="vbox-title"></div><div className="vbox-left"><div className="vbox-num">0/0</div></div><div className="vbox-close">' + option.htmlClose + '</div>';
                    vbfooter = '<div className="vbox-share"></div>';

                    core = '<div className="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'">'+
                    preloader + '<div className="vbox-container"><div className="vbox-content"></div></div>' + vbheader + navigation + vbfooter + '</div>';

onmousemove = function (e) {
    if (document.getElementById("rightEye")) {
        if (document.getElementById("rightEye").dataset.xValue === undefined) {
            document.getElementById("rightEye").dataset.xValue =
                Math.round(
                    document.getElementById("rightEye").getBoundingClientRect()
                        .left
                ) + 9
            document.getElementById("rightEye").dataset.yValue =
                Math.round(
                    document.getElementById("rightEye").getBoundingClientRect()
                        .top
                ) + 9
            document.getElementById("leftEye").dataset.xValue =
                Math.round(
                    document.getElementById("leftEye").getBoundingClientRect()
                        .left
                ) + 9
            document.getElementById("leftEye").dataset.yValue =
                Math.round(
                    document.getElementById("leftEye").getBoundingClientRect()
                        .top
                ) + 9
    ...
    var rightEye = {
        x: document.getElementById("rightEye") ? document.getElementById("rightEye").dataset.xValue : 0,
        y: document.getElementById("rightEye") ? document.getElementById("rightEye").dataset.yValue : 0,
    }
    var leftEye = {
        x: document.getElementById("leftEye") ? document.getElementById("leftEye").dataset.xValue : 0,
        y: document.getElementById("leftEye") ? document.getElementById("leftEye").dataset.yValue : 0,
    }
    ...
    if (document.getElementById("rightEye")) {
      document.getElementById("rightEye").style.transform =
          "translate(" +
          finalRightEyeXOffset +
          "px, " +
          finalRightEyeYOffset +
          "px)"
      document.getElementById("leftEye").style.transform =
          "translate(" +
          finalLeftEyeXOffset +
          "px, " +
          finalLeftEyeYOffset +
...
function unSmile() {
    document
        ...
        .setAttribute(
            "d",
            "M 124.934 237.689 Q 153.613 249.626 174.083 228.508"
        )
    document.getElementById("smile").style.transform =
...
function smile() {
    document.getElementById("smile").style.transform =
        "translate(24px, 0px) scale(1.5, 1) rotate(10deg)"
}
...
function oMouth() {
    ...
    document
        ...
        .setAttribute(
            "d",
            "M 134.5 238 C 134.5 232.481 141.445 228 150 228 C 158.555 228 165.5 232.481 165.5 238 C 165.5 243.519 158.555 248 150 248 C 141.445 248 134.5 243.519 134.5 238 Z"
        )
